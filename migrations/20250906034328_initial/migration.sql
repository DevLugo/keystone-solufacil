...
-- CreateEnum
CREATE TYPE "ReportConfigReportTypeType" AS ENUM ('creditos_con_errores', 'creditos_sin_documentos', 'creditos_completos', 'resumen_semanal', 'reporte_financiero');

-- CreateEnum
CREATE TYPE "ReportConfigChannelType" AS ENUM ('telegram', 'email', 'whatsapp');
...
CREATE TABLE "ReportConfig" (
    ...
    "channel" "ReportConfigChannelType" NOT NULL,
...
CREATE TABLE "TelegramUser" (
    ...
    "reportsReceived" INTEGER DEFAULT 0,
...
-- CreateTable
CREATE TABLE "_Account_routes" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);

-- CreateTable
CREATE TABLE "_ReportConfig_routes" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);

-- CreateTable
CREATE TABLE "_ReportConfig_recipients" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);
...
-- CreateIndex
CREATE INDEX "ReportConfig_createdBy_idx" ON "ReportConfig"("createdBy");

-- CreateIndex
CREATE INDEX "ReportConfig_updatedBy_idx" ON "ReportConfig"("updatedBy");
...
-- CreateIndex
CREATE UNIQUE INDEX "_Account_routes_AB_unique" ON "_Account_routes"("A", "B");

-- CreateIndex
CREATE INDEX "_Account_routes_B_index" ON "_Account_routes"("B");

-- CreateIndex
CREATE UNIQUE INDEX "_ReportConfig_routes_AB_unique" ON "_ReportConfig_routes"("A", "B");

-- CreateIndex
CREATE INDEX "_ReportConfig_routes_B_index" ON "_ReportConfig_routes"("B");

-- CreateIndex
CREATE UNIQUE INDEX "_ReportConfig_recipients_AB_unique" ON "_ReportConfig_recipients"("A", "B");

-- CreateIndex
CREATE INDEX "_ReportConfig_recipients_B_index" ON "_ReportConfig_recipients"("B");
...
-- AddForeignKey
ALTER TABLE "ReportExecutionLog" ADD CONSTRAINT "ReportExecutionLog_reportConfig_fkey" FOREIGN KEY ("reportConfig") REFERENCES "ReportConfig"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ReportConfig" ADD CONSTRAINT "ReportConfig_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ReportConfig" ADD CONSTRAINT "ReportConfig_updatedBy_fkey" FOREIGN KEY ("updatedBy") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_Account_routes" ADD CONSTRAINT "_Account_routes_A_fkey" FOREIGN KEY ("A") REFERENCES "Account"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_Account_routes" ADD CONSTRAINT "_Account_routes_B_fkey" FOREIGN KEY ("B") REFERENCES "Route"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ReportConfig_routes" ADD CONSTRAINT "_ReportConfig_routes_A_fkey" FOREIGN KEY ("A") REFERENCES "ReportConfig"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ReportConfig_routes" ADD CONSTRAINT "_ReportConfig_routes_B_fkey" FOREIGN KEY ("B") REFERENCES "Route"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ReportConfig_recipients" ADD CONSTRAINT "_ReportConfig_recipients_A_fkey" FOREIGN KEY ("A") REFERENCES "ReportConfig"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ReportConfig_recipients" ADD CONSTRAINT "_ReportConfig_recipients_B_fkey" FOREIGN KEY ("B") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
